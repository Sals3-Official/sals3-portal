...
GET /api/storefront/categories/<department-slug>/products?page=1&limit=20
GET /api/storefront/categories/<department-slug>/products?sort=price-asc&minPriceMinor=1500&maxPriceMinor=3000
GET /api/storefront/search?q=lamp&page=1&limit=20
GET /api/storefront/search?q=lamp&category=home-garden&sort=price-asc
```
