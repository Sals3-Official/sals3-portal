 ...
 *
 * The supplier feed reports over a million products, so a numbered page list
 * would be a wall of links that nobody uses. The page number stays in the URL,
 * so a view is still shareable.
 */
export default function CjPagination({
  page,
  totalPages,
  total,
  currentParams,
  ...
  return (
    ...
    >
      <p className="text-sm text-muted-foreground">
        ...
        {total.toLocaleString()} supplier products
      </p>
