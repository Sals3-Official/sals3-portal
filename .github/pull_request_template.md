...
## AJ's process rules (confirmed 2026-08-04/05 — see `../sals3-ecommerce/docs/Wiki/wiki/team-profile-and-collaboration-preferences.md`)
...
## Code gate — `../sals3-ecommerce/docs/Wiki/wiki/nextjs-component-security-code-rules.md`
...
## SEO / GEO / AEO discoverability — `../sals3-ecommerce/docs/Wiki/wiki/sals3-geo-aeo-seo-strategy-proposal.md`

- [ ] If this PR adds, moves, or removes a page/route (PDP, category, cart, checkout, etc.), checked `../sals3-ecommerce/docs/Wiki/wiki/parked-ideas-backlog.md` for GEO/AEO/SEO items whose unblock condition this route now satisfies.
